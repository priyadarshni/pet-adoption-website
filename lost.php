...
if ($mysqli) {
    ...
    $sql = 'select location, img_url, breed, color, email, lost_date from lost_pet_info';
...
<div class="wrapper">
    ...
    <div class="column left">
        <div class="reportCard">
            ...
            <div class="item">  
                <label>Lost Address:   </label><input type="text" name="location" size="35" placeholder="Enter the address">
            </div>
            <div class="item">
            <label>Lost date:  </label><input type="date" name="lost_date">
            </div>
            <div class="item">
    ...
    <?php
        if ('POST' === $_SERVER['REQUEST_METHOD']){
            ...
            if($_POST['breed']!=""){
                ...
                $query = "INSERT INTO  lost-pet-info(breed, color, location, lost_date, email) VALUES('$breed', '$color', '$location', '$lost_date', '$email')";
    ...
    <?php 
        ...
        <div class="petCards">
            ...
            <div class="card-column">
                ...
                <div class="item">
                    <label>Lost Date: </label> <p>'.$this_row['lost_date'].'</p>
                </div>                
            </div>
        </div>';
        }
